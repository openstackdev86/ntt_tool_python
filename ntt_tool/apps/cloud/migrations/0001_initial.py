# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-04-04 07:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('selected_networks', models.ManyToManyField(blank=True, to='cloud.Network')),
                ('tenants', models.ManyToManyField(blank=True, to='cloud.Tenant')),
            ],
            options={
